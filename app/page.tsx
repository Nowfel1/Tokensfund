    ...
    <main className="wrap">
      ...
      <div className="social-row">
        ...
        <a className="social-btn" href="https://t.me/Tokensfund" target="_blank" rel="noopener noreferrer">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.248-1.97 9.289c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L8.048 14.6l-2.948-.924c-.64-.203-.654-.64.136-.95l11.527-4.448c.535-.194 1.003.131.8.97z"/>
          </svg>
          Join Telegram
        </a>
      </div>
