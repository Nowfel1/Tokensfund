 ...
 * Prevents native base tokens from generating invalid strings like 'tao-tao' or 'btc-btc'.
 */
...
export async function buildSwap(
  ...
  // POST /exchange routes rely on standalone fromCurrency and fromNetwork properties
