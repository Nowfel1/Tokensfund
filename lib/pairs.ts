...
export const PAIRS: PairPage[] = [
  ...
  },
  {
    ...
    description:
      "Swap Bitcoin for Zcash without an account or KYC. Non-custodial, wallet to wallet, flat 1% already in the quote. Live quotes from every route that supports the pair.",
    intro:
    ...
    faqs: [
      {
        ...
        a: "Yes, for standard swaps. Send Bitcoin from your own wallet to the one-time deposit address and the ZEC arrives at an address you control. No registration required.",
      },
      {
